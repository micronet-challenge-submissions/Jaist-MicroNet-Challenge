...
![Perplexity](https://github.com/binhdt95/Jaist-MicroNet-Challenge/image/chart.png?raw=true)
...
![Result] (https://github.com/binhdt95/Jaist-MicroNet-Challenge/image/experiments.png?raw=true)

With some experiments, we chose --emsize 300 --nhid 1800 --bptt 300 is the best state. 

![best] (https://github.com/binhdt95/Jaist-MicroNet-Challenge/image/best-state.png?raw=true)
